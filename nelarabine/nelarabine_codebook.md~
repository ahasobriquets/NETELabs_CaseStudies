...
3. The term root is reserved for sunitinib, a tyrosine kinase inhibitor, also known as Sutent (Pfizer), . FDA approval for Sutent was granted in Jan 2006. 
In searching for publications, clinical trials etc. a 60 day allowance was made for 'publication lag' => 03/31/2006
...
5. In the sunitinib study, we also incorporate clinical trials that do not have NCT ids by searching PubMed for sunitinib, applying a date restriction 
(1900/01/01 to 2006/03/31), and publication type as clinical trial. This picked up 5 more pmids and may assume considerable relevance if preceding influential 
