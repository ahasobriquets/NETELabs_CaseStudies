...
psql -d elsevier -c "create table  ${drug_name}_scopus_pub_cites(pub_sid varchar(30),ref_sidvarchar(30),source_year varchar(4), source_name varchar(500),source_volume varchar(500), source_first_page varchar(500), source_last_page varchar(500), title text, text text ) "
