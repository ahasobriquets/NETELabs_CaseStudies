...
from :author_pub a
inner join alemtuzumab_testnetwork_pub_pir b
...
select auth_sid,full_name,doc_count_test,doc_count as doc_count_total, doc_count_test/doc_count::float as auth_rrbr,auth_pir
...
select case when auth_pir=merged_auth_pir THEN '0' ELSE '1' END as is_merged, auth_sid ,a.full_name,doc_count_test,doc_count_total,auth_rrbr,auth_pir,merged_doc_count_test,merged_doc_count_total, merged_doc_count_test/merged_doc_count_total as merged_rrbr ,merged_auth_pir
